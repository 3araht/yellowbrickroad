...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FLIPTRANS] = LAYOUT(
        ...
        _______, _______,  _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______,  _______,  _______, _______,
        _______, MI_TRNSU, MI_TRNSD,
        _______
    ),

    [_FN] = LAYOUT(
        _______, RGB_RMOD, RGB_MOD,
        TGLTRNS, TGLFLIP, TGLBASS,  TGLMICH, MELDYAL, MELODYS, MELDYAH, TGLUVEL, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX,
        BASELAY, CHORDSB,  BASECHO, HEPTATO, PENTATO, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX,
        FLIPBAS, FLIPCHO,  FLIPBAC, FLIPHEP, FLIPPEN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX,
        RGB_SAD, RGB_SAI,  RGB_HUD, RGB_HUI, RGB_SPD, RGB_SPI, RGB_VAD, RGB_VAI, RGB_RMOD, RGB_MOD, TGLINDI, RGB_TOG,
    ...
    if (rgb_matrix_is_enabled()) {  // turn the lights on when it is enabled.
        ...
        switch (layer_state) {
            ...
            case _LS_FN ... _LS_MAX:  //  When Mute Button is long-pressed, the previous layers are still active.
                rgb_matrix_set_color(1,  RGB_DARKSPRINGGREEN);  //  TGLTRNS
                rgb_matrix_set_color(2,  RGB_DARKCHARTREUSE);   //  TGLFLIP
                rgb_matrix_set_color(3,  RGB_DARKCORAL);        //  TGLBASS
                rgb_matrix_set_color(4,  RGB_DARKTEAL);         //  TGLMICH
                rgb_matrix_set_color(5,  RGB_DARKCYAN);         //  MELDYAL
                rgb_matrix_set_color(6,  RGB_DARKGOLD);         //  MELODYS
                rgb_matrix_set_color(7,  RGB_DARKSPRINGGREEN);  //  MELDYAH
                rgb_matrix_set_color(8,  RGB_DARKCORAL);        //  TGLUVEL
                for (i = 13; i < 18; i++) {
                ...
                rgb_matrix_set_color(47, RGB_DARKSPRINGGREEN);  //  TGLINDI
                rgb_matrix_set_color(48, RGB_DARKRED);          //  RGB_TOG
