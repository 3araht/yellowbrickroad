...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        FN_MUTE,      KC_VOLD,     KC_VOLU,
        MI_C_1,       MI_Db_1,     MI_D_1,       MI_Eb_1,       MI_E_1,       MI_F_1,      MI_Fs_1,
        MI_G_1,       MI_Ab_1,     MI_A_1,       MI_Bb_1,       MI_B_1,       MI_C_2,      MI_Db_2,     MI_D_2,         MI_Eb_2,     MI_E_2,       MI_F_2,      MI_Fs_2,   MI_G_2,   MI_Ab_2,
        MI_A_2,       MI_Bb_2,     MI_B_2,       MI_C_3,        MI_Db_3,      MI_D_3,      MI_Eb_3,     MI_E_3,         MI_F_3,      MI_Fs_3,      MI_G_3,      MI_Ab_3,   MI_A_3,   MI_Bb_3,  MI_B_3,    MI_C_4,     MI_Db_4,      MI_D_4,      MI_Eb_4,      MI_E_4,       MI_F_4,
        MI_Fs_4,      MI_G_4,      MI_Ab_4,      MI_A_4,        MI_Bb_4,      MI_B_4,      MI_C_5,      MI_Db_5,        MI_D_5,      MI_Eb_5,      MI_E_5,
        SHLAYER,      MI_TRNSD,    MI_TRNSU,
        MI_SUS
    ),

    [_CHORDS] = LAYOUT(
        _______,      _______,     _______,
        MI_CH_Cr,     MI_CH_Dbr,   MI_CH_Dr,     MI_CH_Ebr,     MI_CH_Er,     MI_CH_Fr,    MI_CH_Fsr,
        MI_CH_Gr,     MI_CH_Abr,   MI_CH_Ar,     MI_CH_Bbr,     MI_CH_Br,     MI_CH_C,     MI_CH_Db,     MI_CH_D,       MI_CH_Eb,    MI_CH_E,      MI_CH_F,     MI_CH_Fs,  MI_CH_G,  MI_CH_Ab,
        MI_CH_A,      MI_CH_Bb,    MI_CH_B,      MI_CH_Cm,      MI_CH_Dbm,    MI_CH_Dm,    MI_CH_Ebm,    MI_CH_Em,      MI_CH_Fm,    MI_CH_Fsm,    MI_CH_Gm,    MI_CH_Abm, MI_CH_Am, MI_CH_Bbm, MI_CH_Bm, MI_CH_CDom7, MI_CH_DbDom7, MI_CH_DDom7, MI_CH_EbDom7, MI_CH_EDom7, MI_CH_FDom7,
        MI_CH_FsDom7, MI_CH_GDom7, MI_CH_AbDom7, MI_CH_ADom7,   MI_CH_BbDom7, MI_CH_BDom7, MI_CH_CDim7,  MI_CH_DbDim7,  MI_CH_DDim7, MI_CH_EbDim7, MI_CH_EDim7,
        _______,      _______,     _______,
        _______
    ),
    ...
    [_BASEANDCHORDS] = LAYOUT(
        _______,     _______,      _______,
        MI_C_2,      MI_Db_2,      MI_D_2,       MI_Eb_2,       MI_E_2,       MI_F_2,      MI_Fs_2,
        MI_G_2,      MI_Ab_2,      MI_A_2,       MI_Bb_2,       MI_B_2,       MI_C_3,      MI_Db_3,      MI_D_3,        MI_Eb_3,     MI_E_3,       MI_F_3,      MI_Fs_3,   MI_G_3,   MI_Ab_3,
        MI_A_3,      MI_Bb_3,      MI_B_3,       MI_CH_C,       MI_CH_Db,     MI_CH_D,     MI_CH_Eb,     MI_CH_E,       MI_CH_F,     MI_CH_Fs,     MI_CH_G,     MI_CH_Ab,  MI_CH_A,  MI_CH_Bb,  MI_CH_B,  MI_CH_Cm,    MI_CH_Dbm,    MI_CH_Dm,    MI_CH_Ebm,    MI_CH_Em,    MI_CH_Fm,
        MI_CH_Fsm,   MI_CH_Gm,     MI_CH_Abm,    MI_CH_Am,      MI_CH_Bbm,    MI_CH_Bm,    MI_CH_CDom7,  MI_CH_DbDom7,  MI_CH_DDom7, MI_CH_EbDom7, MI_CH_EDom7,
        _______,     _______,      _______,
        _______
    ),
    ...
    [_HEPTATONIC] = LAYOUT(
        ...
        MI_C_3,      MI_D_3,       MI_E_3,       MI_F_3,        MI_G_3,       MI_A_3,       MI_B_3,      MI_C_4,        MI_D_4,      MI_E_4,       MI_F_4,      MI_G_4,    MI_A_4,   MI_B_4,    MI_C_5,   MI_D_5,      MI_E_5,       MI_F_5,       MI_G_5,      MI_A_5,      MI_B_5,
        MI_CH_C,     MI_CH_D,      MI_CH_E,      MI_CH_F,       MI_CH_G,      MI_CH_A,      MI_CH_B,     MI_CH_Cm,      MI_CH_Dm,    MI_CH_Em,     MI_CH_Fm,
        _______, _______, _______,
        _______
    ),
    ...
    [_PENTATONIC] = LAYOUT(
        _______, _______, _______,
        MI_C,        MI_D,         MI_E,         MI_G,          MI_A,         MI_C_1,       MI_D_1,
        MI_E_1,      MI_G_1,       MI_A_1,       MI_C_2,        MI_D_2,       MI_E_2,       MI_G_2,      MI_A_2,        MI_C_3,      MI_D_3,      MI_E_3,      MI_G_3,     MI_A_3,   MI_C_4,
        MI_D_4,      MI_E_4,       MI_G_4,       MI_A_4,        MI_C_5,       MI_D_5,       MI_E_5,      MI_G_5,        MI_A_5,      MI_CH_Cr,    MI_CH_Dr,    MI_CH_Er,   MI_CH_Gr, MI_CH_Ar,    MI_CH_C,     MI_CH_D,     MI_CH_E,    MI_CH_G,  MI_CH_A,   MI_CH_Cm,    MI_CH_Dm,
        MI_CH_Em,    MI_CH_Gm,     MI_CH_Am,     MI_CH_CDom7,   MI_CH_DDom7,  MI_CH_EDom7,  MI_CH_GDom7, MI_CH_ADom7,   MI_CH_CDim7, MI_CH_DDim7, MI_CH_EDim7,
        _______, _______, _______,
        _______
    ),

    [_FN] = LAYOUT(
        _______,     RGB_RMOD,     RGB_MOD,
